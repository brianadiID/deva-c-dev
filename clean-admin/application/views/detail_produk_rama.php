                    ...
                    <h6><?php echo $related['sku']; ?></h6> 
                        ...
                        <div class="item_inner">
                            <div class="item_image">
                                ...
                                <input type="hidden" name="qty" id="sst2" value="1">
                                <button type="button" data-qty='1' data-produkid="<?php echo $related['id'] ?>" data-produknama="<?php echo $related['sku'] ?>" data-produkharga="<?php echo $related['harga'] ?>" data-gambar="<?php echo $related['gambar_produk']; ?>" class="add_cart_related btn cart_button_gray"><i class="fa fa-shopping-cart"></i>  Beli</button>
                            </div>  
                            <div class="item_info">
