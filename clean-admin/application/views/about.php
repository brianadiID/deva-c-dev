...
<!-- Content  -->
     <center><h1 class="m-5" style="font-size: 4.05rem;">ABOUT</h1></center>
   <section class="welcome_area">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="row m0 db img_area">
                    <img src="http://isshue.bdtask.com/isshue-v1.1/my-assets/image/link_page/071c2e33227800faf022ac9947cd9f8c.jpg" alt="Img">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="welcome_inner">
                    <h2>Welcome To <span>Theklakklik</span></h2>                    <p class="text-justify">The European languages are members of the same family. Their separate existence is a myth. For science, music, sport, etc, Europe uses the same vocabulary. The languages only differ in their grammar, their pronunciation and their most common words. Everyone realizes why a new common language would be desirable: one could refuse to pay expensive translators. To achieve this, it would be necessary to have uniform grammar, pronunciation and more common words.</p>                </div>
            </div>
        </div>
    </div>
</section>
