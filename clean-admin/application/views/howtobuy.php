            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="welcome_inner">
                        <h2>Bingung cara berbelanja di<span>Theklakklik.com</span>?</h2>
                        <h4>Simak tata cara belanja berikut ini</h4>
                        
                    </div>

                    <!---->
                    <p class="center m-5">
  <button class="btn btn-success btn-click" data-toggle="collapse" data-target="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">A.Cari Produk</button>
  <button class="btn btn-success btn-click" type="button" data-toggle="collapse" data-target="#multiCollapseExample2" aria-expanded="false" aria-controls="multiCollapseExample2">B.Masukan ke kranjang belanja</button>
  <button class="btn btn-success btn-click" type="button" data-toggle="collapse" data-target="#multiCollapseExample3" aria-expanded="false" aria-controls="multiCollapseExample2">C.Masukan alamat &amp; Pembayaran</button>                        
  ...
  <div class="col-lg-4">
    <div class="collapse multi-collapse " id="multiCollapseExample1">
      <div class="card card-body">
          <img src="<?php echo base_url()?>/isshue-v1.1/my-assets/image/howtobuy/1.png">
        Jelajahi berbagai kategori dan sub-kategori atau gunakan fitur Cari. Pada halaman produk, Anda dapat meng-klik untuk membuat penawaran, untuk memasukkan produk ke keranjang belanja, atau untuk membuat pesanan.
      </div>
    </div>
  </div>
  <div class="col-lg-4">
    <div class="collapse multi-collapse " id="multiCollapseExample2">
      <div class="card card-body">
           <img src="<?php echo base_url()?>/isshue-v1.1/my-assets/image/howtobuy/2.png">
Pilih produk yang Anda inginkan dan klik . Pilih alamat pengiriman, opsi pengiriman, metode pembayaran dan klik
      </div>
    </div>
  </div>
    <div class="col-lg-4">
