...
<body>
    ...
    <!-- Content  -->
    <div class="container">
        <h1 class="m-4" style="font-size: 1.55rem;">Forgot Password Page</h1>
    </div>
    <form method="post" action="<?php echo base_url(); ?>customer/send_email_for_change_password">
        <div class="container p-5" style="background:white;">
            <div class="row">
                <div class="col-lg-12">                
                  <div class="form-group">
                    <label for="formGroupExampleInput">Input your Email</label>
                    <input type="text" class="form-control box" id="formGroupExampleInput" name="email" placeholder="Email">
                    <?php echo validation_errors(); ?>
                  </div>
                  <div class="form-group">
                    <button type="submit" class="btn btn-success w100">Send Change Password Confirmation</button>
                  </div>
                </div>
            </div>
        </div>
