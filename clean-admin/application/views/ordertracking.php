   ...
   <div class="col-md-12">
        <div class="well">
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 m-2 col-sm-10">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item"><a href="//tracking/link/goes/here">traking link</a></li>
            </ul>
