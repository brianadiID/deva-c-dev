...
<!-- Content  --><div class="container">
     <center><h1 class="m-5" style="font-size: 4.05rem;">CONTACT</h1><p>Are you curious about something? As am hastily invited settled at limited civilly fortune me. Really spring in extent an by. Judge but built party world. Of so am he remember although required. Bachelor unpacked be advanced at. Confined in declared marianne is vicinity.</p></center></div>
        <!---->
      ...
      <div class="container">       
        <div class="row">
          <div class="col-md-4 col-xs-12 text-center text-md-left p-2 ">
            <i class="fa fa-map-o m-2" style="font-size:48px;color:green;"></i>
          ...
          <div class="col-md-4 col-xs-12 text-center text-md-left p-2">
            <i class="fa fa-phone m-2" style="font-size:48px;color:blue"></i>
          ...
          <div class="col-md-4 col-xs-12 text-center text-md-left p-2">
            <i class="fa fa-plug m-2" style="font-size:48px;color:black"></i>
  ...
  <div class="container-fluid"   >
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d22440.331566126868!2d106.878240924098!3d-6.140420738433865!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f5667ef5460b%3A0x7713a14c78e7dc5c!2sTelesindo+Tunggal+Mandiri+Sukses!5e0!3m2!1sid!2sid!4v1535620836068" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
        </div>
