            ...
            <div class="container-fluid">
                      ...
                      <!--   <a href="?action=add"><button type="button" class="btn btn-success m-b-10"><i class="fa fa-plus-circle"></i> Add Order</button></a> -->
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Manage Quotation</h4>
                                        <h6 class="card-subtitle">Quotation Data</h6>
                                        <hr>
                                                    ...
                                                    <tr data-id="<?php echo $order_data->id ;?>" role="row">
                                                        ...
                                                        <td>
                                                            ...
                                                            if($order_data->status_order == 0){
                                                                echo "<span class='badge badge-pill badge-primary'>Request For Quotation</span>";
                                                            }elseif($order_data->status_order == 1){
                                                                echo "<span class='badge badge-pill badge-success'>Convert to Invoice</span>";
                                                            }
                ...
                <!-- Edit Data -->
                    <?php if($action == 'edit') { ?>
                        ...
                        <!-- End Bread crumb and right sidebar toggle -->
                        <!-- ============================================================== --> 
                        <a href="<?php echo base_url('admin-area/quotation') ?>"><button type="button" class="btn btn-warning m-b-10"><i class="fa fa-plus-circle"></i> Manage Quotation</button></a>   
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body ">
                                            <h4 class="card-title">Edit Quotation</h4>
                                            <h6 class="card-subtitle">Edit new Quotation </h6>
                                            ...
                                            <?php foreach ($data_edit as $data_edit): ?>
                                                ...
                                                <form class="m-t-40 p-20" action="<?php echo base_url('admin-area/update_quotation'); ?>" method="post" enctype="multipart/form-data" novalidate>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select required data-validation-required-message="This field is required" class="form-control" name="status">
                                                                <option value="0" <?php if($data_edit->status_order == 0) echo "selected"; ?> >Request for Quotation</option>
                                                                <option value="1" <?php if($data_edit->status_order == 1) echo "selected"; ?> >Convert to Invoice</option>                                                            
                                                       <!--          <option value="2" <?php if($data_edit->status_order == 2) echo "selected"; ?> >Success</option>                                                            
                                                                <option value="99" <?php if($data_edit->status_order == 99) echo "selected"; ?> >Cancel</option> -->                                                            
                                                            </select>
                                                            </div>
