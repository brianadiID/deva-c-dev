            ...
            <div class="container-fluid">
                ...
                <!-- Create Data -->
                    <?php if($action == 'add') { ?>
                        ...
                        <!-- ============================================================== --> 
                        <a href="<?php echo base_url('admin-area/coupon') ?>"><button type="button" class="btn btn-warning m-b-10"><i class="fa fa-plus-circle"></i> Manage Coupon</button></a>   
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">Add Coupon</h4>
                                            <h6 class="card-subtitle">Add new Coupon </h6>

                                           


                                            <form class="m-t-40" action="<?php echo base_url('admin-area/create-coupon'); ?>" method="post" enctype="multipart/form-data" novalidate>

                                                    
                                                <div class="form-group">
                                                    <h5>Judul Coupon<span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="text" name="judul_coupon"  class="form-control" required data-validation-required-message="This field is required"> </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <h5>Code Coupon<span class="text-danger">*</span></h5>
                                                            <div class="controls">
                                                                <input type="text" name="code_coupon"  class="form-control" required data-validation-required-message="This field is required"> 
                                                            </div>
                                                            <div class="form-control-feedback"></div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <h5 class="">Waktu Aktif</h5>
                                                            <!-- <p class="text-muted m-b-20">just add id <code>#date-range</code> to create it.</p> -->
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" name="waktu_aktif" id="datepicker-autoclose" placeholder="mm/dd/yyyy">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <h5 class="">Waktu Berakhir</h5>
                                                            <!-- <p class="text-muted m-b-20">just add id <code>#date-range</code> to create it.</p> -->
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" name="waktu_berakhir" id="datepicker-autoclose2" placeholder="mm/dd/yyyy">
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text"><i class="icon-calender"></i></span>
                                                                </div>
                                                            </div>
                                                 ...
                                                 <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                        <input type="file" id="input-file-now-custom-3" name="gambar" class="dropify"  class="form-control" >
                                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="keterangan"  class="form-control" required data-validation-required-message="This field is required"> 
                                                            </div>
                                                            <div class="form-control-feedback"></div>
                                                        </div>
                ...
                <!-- Read data -->
                    <?php if($action == '') {?> 
                        ...
                        <a href="?action=add"><button type="button" class="btn btn-success m-b-10"><i class="fa fa-plus-circle"></i> Add Coupon</button></a>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Manage Coupon</h4>
                                        <h6 class="card-subtitle">Coupon Data</h6>
                                        <hr>
                                        ...
                                        <div class="table-responsive ">
                                            ...
                                            <table id="tabelKu" class="nowrap table table-bordered table-striped ">
                                                ...
                                                <tbody>
                                                <?php $no=1; foreach ($data_coupon as $coupon_data): ?>
                                                    <tr data-id="<?php echo $coupon_data->id ;?>" role="row">

                                                        <td><?php echo $coupon_data->id ; ?></td>
                                                        <td><img src="<?php echo base_url();?>my-assets/image/coupon/<?php echo $coupon_data->gambar ; ?>" alt="<?php echo $coupon_data->gambar ; ?>" width='100'> 
                                                        </td>

                                                        <td><?php echo $coupon_data->judul_coupon ; ?></td>
                                                        

                                                        <td><?php echo $coupon_data->coupon_code ; ?></td>                                                  
                                                        <td><?php echo $coupon_data->discount ; ?></td>                                                  
                                                        <td><?php echo $coupon_data->tanggal_aktif ; ?></td>                                                  
                                                        <td><?php echo $coupon_data->tanggal_selesai ; ?></td>                                                  
                                                        <td><?php if($coupon_data->status == 1 ) echo '<span class="label label-success">ON</span>'; else echo '<span class="label label-danger">OFF</span>' ; ?></td>
                                                        <td><?php echo $coupon_data->keterangan ; ?></td>                                                  

                                                        <td>

                                                            <a href="?action=edit&id=<?php echo $coupon_data->id ;?>"><button type="button" class="btn btn-sm btn-icon btn-pure btn-outline edit-row-btn" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit" aria-hidden="true"></i></button></a>

                                                            <button type="button" data-id="<?php echo $coupon_data->id ;?>" data-name="<?php echo $coupon_data->judul_coupon ;?>" data-logo="<?php  echo $coupon_data->gambar ?>" class="btn btn-sm btn-icon btn-danger btn-outline delete-row-btn hapus-coupon" data-toggle="tooltip" data-original-title="Delete" ><i class="ti-trash" aria-hidden="true"></i></button>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h6 class="card-subtitle">Edit new Coupon s</h6>

                                           

                                        
                                                
                                        <?php foreach ($data_coupon_edit as $data_edit): ?>
                                            <form class="m-t-40" action="<?php echo base_url('admin-area/update-coupon'); ?>" method="post" enctype="multipart/form-data" novalidate>

                                                    
                                                <div class="form-group">
                                                    <h5>Judul Coupon<span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="text" name="judul_coupon" value="<?php echo $data_edit->judul_coupon; ?>" class="form-control" required data-validation-required-message="This field is required"> 
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <h5>Code Coupon<span class="text-danger">*</span></h5>
                                                            <div class="controls">
                                                                <input type="text" name="code_coupon" value="<?php echo $data_edit->coupon_code; ?>"  class="form-control" required data-validation-required-message="This field is required"> 
                                                            </div>
                                                            <div class="form-control-feedback"></div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            <h5>Discount <span class="text-danger">*</span></h5>
                                                            <div class="controls">
                                                            <input id="tch1" type="number" value="<?php echo $data_edit->discount; ?>" 
                                                            name="discount" data-bts-button-down-class="btn btn-secondary btn-outline"  data-bts-button-up-class="btn btn-secondary btn-outline"  required data-validation-required-message="This field is required">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <!-- <p class="text-muted m-b-20">just add id <code>#date-range</code> to create it.</p> -->
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" name="waktu_aktif" id="datepicker-autoclose" placeholder="mm/dd/yyyy" value="<?php echo date('d/m/Y', strtotime($data_edit->tanggal_aktif)); ?>">
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text"><i class="icon-calender"></i></span>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <!-- <p class="text-muted m-b-20">just add id <code>#date-range</code> to create it.</p> -->
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" name="waktu_berakhir" id="datepicker-autoclose2" placeholder="mm/dd/yyyy"  value="<?php echo date('d/m/Y', strtotime($data_edit->tanggal_selesai)); ?>">
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text"><i class="icon-calender"></i></span>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <fieldset class="controls">
                                                                <div class="custom-control custom-radio">
                                                                    <input type="radio" value="1" <?php if($data_edit->status == 1) echo 'checked'; ?> name="status" required id="styled_radio1" class="custom-control-input">
                                                                    <label class="custom-control-label" for="styled_radio1">Aktif</label>
                                                                </div>
                                                            
                                                                <div class="custom-control custom-radio">
                                                                    <input type="radio" value="0" name="status" <?php if($data_edit->status == 0) echo 'checked'; ?> id="styled_radio2" class="custom-control-input">
                                                                    <label class="custom-control-label" for="styled_radio2">Nonaktif</label>
                                                                </div>
                                                            </fieldset>
                                                            </div>
                                                 ...
                                                 <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        <h5>Pilih Gambar <span class="text-danger">*</span></h5>
                                                        <div class="controls">
                                                        <input type="file" id="input-file-now-custom-3" name="gambar" class="dropify"  class="form-control" data-default-file="<?php echo base_url();?>my-assets/image/coupon/<?php echo $data_edit->gambar ; ?>" value="<?php echo $data_edit->gambar ; ?>" class="form-control"  >
                                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <h5>Keterangan<span class="text-danger">*</span></h5>
                                                            <div class="controls">
                                                                <input type="text" name="keterangan" value="<?php echo $data_edit->keterangan ?>" class="form-control" required data-validation-required-message="This field is required"> 
                                                            </div>
                                                            <div class="form-control-feedback"></div>
                                                        </div>
