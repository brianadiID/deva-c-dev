            ...
            <div class="container-fluid">
                ...
                <!-- Read data -->
                    <?php if($action == '') {?> 
                        ...
                        <a href="?action=add"><button type="button" class="btn btn-success m-b-10"><i class="fa fa-plus-circle"></i> Add Brand</button></a>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Manage Brand</h4>
                                        <h6 class="card-subtitle">Brand Data</h6>
                                        <hr>
                                        ...
                                        <div class="table-responsive ">
                                            ...
                                            <table id="tabelKu" class="nowrap table table-bordered table-striped ">
                                                ...
                                                <tbody>
                                                <?php $no=1; foreach ($data_brand as $brand_data): ?>
                                                    <tr data-id="<?php echo $brand_data->id ;?>" role="row">

                                                        <td><?php echo $brand_data->id ; ?></td>
                                                        <td><?php echo $brand_data->nama_brand ; ?></td>
                                                        <td><img src="<?php echo base_url();?>my-assets/image/brand/<?php echo $brand_data->logo ; ?>" alt="<?php echo $brand_data->logo ; ?>" width='100'> 
                                                        </td>

                                                        <td><?php echo $brand_data->website ; ?></td>                                                  
                                                        <td>

                                                            <a href="?action=edit&id=<?php echo $brand_data->id ;?>"><button type="button" class="btn btn-sm btn-icon btn-pure btn-outline edit-row-btn" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit" aria-hidden="true"></i></button></a>

                                                            <button type="button" data-id="<?php echo $brand_data->id ;?>" data-name="<?php echo $brand_data->nama_brand ;?>" data-logo="<?php  echo $brand_data->logo ?>" class="btn btn-sm btn-icon btn-danger btn-outline delete-row-btn hapus-brand" data-toggle="tooltip" data-original-title="Delete" ><i class="ti-trash" aria-hidden="true"></i></button>
                ...
                <!-- Create Data -->
                    <?php if($action == 'add') { ?>
                        ...
                        <!-- End Bread crumb and right sidebar toggle -->
                        <!-- ============================================================== --> 
                        <a href="<?php echo base_url('admin-area/brand') ?>"><button type="button" class="btn btn-warning m-b-10"><i class="fa fa-plus-circle"></i> Manage Brand</button></a>   
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">Add Brand</h4>
                                            <h6 class="card-subtitle">Add new Brand </h6>

                                           


                                            <form class="m-t-40" action="<?php echo base_url('admin-area/create-brand'); ?>" method="post" enctype="multipart/form-data" novalidate>

                                                    
                                                <div class="form-group">
                                                    <h5>Nama Brand<span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="text" name="nama_brand"  class="form-control" required data-validation-required-message="This field is required"> </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                    <div class="form-group">
                                                        <h5>Pilih Logo <span class="text-danger">*</span></h5>
                                                        <div class="controls">
                                                        <input type="file" id="input-file-now-custom-3" name="logo" class="dropify"  class="form-control"  >
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="website"  class="form-control" placeholder="Add URL" data-validation-regex-regex="((http[s]?|ftp[s]?):\/\/)?([\da-z\.-]+)\.([a-z\.]{2,6})([\/\w \.-]*)*" data-validation-regex-message="Only Valid URL's" aria-invalid="false">
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h6 class="card-subtitle">Edit new Brand s</h6>

                                           

                                        
                                                
                                        <?php foreach ($data_brand_edit as $data_edit): ?>
                                               
                                            
                                            <form class="m-t-40" action="<?php echo base_url('admin-area/update-brand'); ?>" method="post" enctype="multipart/form-data" novalidate>

                                                <div class="form-group">
                                                    <h5>Nama Brand<span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="hidden" name="id" value="<?php echo $data_edit->id; ?>">
                                                        <input type="text" name="nama_brand" value="<?php  echo $data_edit->nama_brand; ?>"  class="form-control" required data-validation-required-message="This field is required"> </div>
                                                    <div class="form-control-feedback"></div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        <h5>Pilih Logo <span class="text-danger">*</span></h5>
                                                        <div class="controls">
                                                        <input type="file" id="input-file-now-custom-3" name="logo" class="dropify"  class="form-control" data-default-file="<?php echo base_url();?>my-assets/image/brand/<?php echo $data_edit->logo ; ?>" value="<?php echo $data_edit->logo ; ?>" class="form-control"  >
                                                        <input type="hidden" name="logo_old" value="<?php echo $data_edit->logo ; ?>">
                                                    ...
                                                    <div class="form-group">
                                                        <h5>website<span class="text-danger">*</span></h5>
                                                        <div class="controls">
                                                            <input type="text" name="website" value="<?php echo $data_edit->website ?>" class="form-control" placeholder="Add URL" data-validation-regex-regex="((http[s]?|ftp[s]?):\/\/)?([\da-z\.-]+)\.([a-z\.]{2,6})([\/\w \.-]*)*" data-validation-regex-message="Only Valid URL's" aria-invalid="false">
