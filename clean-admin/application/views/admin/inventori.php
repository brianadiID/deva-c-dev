...
<head>
    ...
    <?php if($data_inventori == 'add') {?>
        <title>Add inventori</title>
    <?php }elseif($data_inventori == 'edit'){?>
        <title>Edit inventori</title>
    <?php }else{?>
        <title>Manage inventori</title>
    <?php } ?>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">inventori</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li class="breadcrumb-item active">Manage inventori</li>
                ...
                <!-- ============================================================== --> 
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">Manage inventori</h4>
                                            <h6 class="card-subtitle">inventori content</h6>
                                            ...
                                            <table id="tabelKu" class="nowrap table table-bordered table-striped ">
                                                ...
                                                <tbody>
                                                <?php $no=1; foreach ($data_inventori as $data_inventori): ?>
                                                    <tr data-id="<?php echo $data_inventori->id ;?>" role="row">

                                                        <td><?php echo $data_inventori->id ; ?></td>
                                                        <td><?php echo $data_inventori->sku ; ?></td>
                                                        <td><?php echo $data_inventori->stok ; ?></td>
                                                                                                       
                                                        <td>

                                                            <a href="?action=edit&id=<?php echo $data_inventori->id ;?>"><button type="button" class="btn btn-sm btn-icon btn-pure btn-outline edit-row-btn" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit" aria-hidden="true"></i></button></a>

                                                           <!-- <button type="button" data-id="<?php echo $data_inventori->id ;?>" data-name="<?php echo $data_inventori->sku ;?>"  class="btn btn-sm btn-icon btn-danger btn-outline delete-row-btn hapus-inventori" data-toggle="tooltip" data-original-title="Delete" ><i class="ti-trash" aria-hidden="true"></i></button>-->
...
<!-- ==================================================================================================================== -->
    ...
    $(document).on("click",".hapus-inventori",function(){
    ...
    // var nama=$(this).attr("data-name");
        ...
        swal({   
            ...
            if (isConfirm) {  
                $.ajax({
                data:{id:id},
                url:"<?php echo base_url('Admin-area/delete-inventori');?>",
