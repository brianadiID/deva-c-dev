...
<head>
    ...
    <?php if($data_slider == 'add') {?>
        <title>Add slider </title>
    <?php }elseif($data_slider == 'edit'){?>
                ...
                <div class="row">
                  <div class="col-12">
                      <div class="card">
                            ...
                            <h6 class="card-subtitle">add Data</h6>
                        <form class="m-t-40" action="<?php echo base_url('admin-area/add-slider'); ?>" method="post" enctype="multipart/form-data" novalidate>    
                            <div class="row">
                                
                          <?php foreach ($data_slider as $data_slider): ?>
                         <div class="col">      
                                <div class="form-group" > 
                                <h5>Link </h5><div class="controls">
                                        <input  type="text" class="form-control form-control-line" name="link" value="<?php echo $data_slider->link_url; ?>" >
                                    </div>
                                </div>
                                                        
                                <div class="form-group">
                                     <h5>Pilih Gambar Slider <span class="text-danger">*</span></h5>
                                    <div class="controls">
                                     <input type="file" id="input-file-now-custom-3" data-default-file="<?php echo base_url(); ?>my-assets/image/slider/<?php echo $data_slider->gambar; ?>" 
                                            
                                            name="gambar" class="dropify" data-height="350"  class="form-control"  >
                                     </div>

                                 </div>
                             
                                 <div class="form-group" > 
                                  <h5>Simpan </h5><div class="controls">
                      ...
                      <div class="card">
                        ...
                        <form class="m-t-40" action="<?php echo base_url('admin-area/add-slider'); ?>" method="post" enctype="multipart/form-data" novalidate>    
                         ...
                         <div class="col">      
                                <div class="form-group" > 
                                <h5>Link </h5><div class="controls">
                                        <input  type="text" class="form-control form-control-line" name="link" placeholder="Link Url" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                     <h5>Pilih Gambar Slider <span class="text-danger">*</span></h5>
                                    <div class="controls">
                                     <input type="file" id="input-file-now-custom-3" name="gambar" class="dropify" data-height="350"  class="form-control"  >
                                     </div>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h6 class="card-subtitle">slider content</h6>
                                            <a href="?action=add"><button type="button" class="btn btn-success m-b-10"><i class="fa fa-plus-circle"></i> Add slider</button></a>
                                            ...
                                            <table id="tabelKu" class="nowrap table table-bordered table-striped ">
                                                ...
                                                <tbody>
                                                <?php $no=1; foreach ($data_slider as $data_slider):
                                                 
                                                    
                                                    ?>
                                                    <tr data-id="<?php echo $data_slider->id ;?>" role="row">

                                                        <td><?php echo $data_slider->id ; ?></td>
                                                        <td><img src="<?php echo base_url() ?>my-assets/image/slider/<?php echo $data_slider->gambar ; ?>" alt="<?php echo $data_slider->gambar ; ?>" width="40" class="img-circle"></td>
                                                       
                                                        <td><?php echo $data_slider->link_url ; ?></td>
                                                        <td>

                                                            <a href="?action=edit&id=<?php echo $data_slider->id ;?>"><button type="button" class="btn btn-sm btn-icon btn-pure btn-outline edit-row-btn" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-edit" aria-hidden="true"></i></button></a>

                                                            <button type="button" data-id="<?php echo $data_slider->id ;?>" data-name="<?php?>"  class="btn btn-sm btn-icon btn-danger btn-outline delete-row-btn hapus-slider" data-toggle="tooltip" data-original-title="Delete" ><i class="ti-trash" aria-hidden="true"></i></button>
...
<!-- ==================================================================================================================== -->
    ...
    $(document).on("click",".hapus-slider",function(){
    ...
    // var nama=$(this).attr("data-name");
        ...
        swal({   
            ...
            if (isConfirm) {  
                $.ajax({
                data:{id:id},
                url:"<?php echo base_url('Admin-area/delete-slider');?>",
