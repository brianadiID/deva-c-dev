...
<head>
    ...
    <?php if($data_konfirmasi == 'add') {?>
        <title>Add Konfirmasi transfer</title>
    <?php }elseif($data_konfirmasi == 'edit'){?>
        <title>Edit Konfirmasi transfer</title>
    <?php }else{?>
        <title>Manage Konfirmasi transfer</title>
    <?php } ?>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Konfirmasi</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li class="breadcrumb-item active">Manage Konfirmasi transfer</li>
...
<?php if($action=='') { ?>                                 
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">Manage Konfirmasi</h4>
                                            <h6 class="card-subtitle">Konfirmasi content</h6>
...
<!-- ==================================================================================================================== -->
    ...
    $(document).on("click",".hapus-konfirmasi",function(){
    ...
    // var nama=$(this).attr("data-name");
        ...
        swal({   
            ...
            if (isConfirm) {  
                $.ajax({
                data:{id:id},
                url:"<?php echo base_url('Admin-area/delete-konfirmasi');?>",
