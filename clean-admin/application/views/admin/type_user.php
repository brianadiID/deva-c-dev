...
<head>
    ...
    <?php if($action == 'add') {?>
        <title>Add Type User</title>
    <?php }elseif($action == 'edit'){?>
        <title>Edit Type User</title>
    <?php }else{?>
        <title>Manage Type User</title>
    <?php } ?>
            ...
            <div class="container-fluid">
                ...
                <!-- CUSTOM SONTENT HERE !! -->
                            ...
                            <div class="col-md-7 align-self-center text-right">
                                <div class="d-flex justify-content-end align-items-center">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">Add Type User</li
                                    </ol>
                    ...
                    <?php if($action == '') {?> 
                            ...
                            <div class="col-md-7 align-self-center text-right">
                                <div class="d-flex justify-content-end align-items-center">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                        <li class="breadcrumb-item">Type User</li>
                                        <li class="breadcrumb-item active">Manage Type User</li
                                    </ol>
                                    <!-- <button type="button" class="btn btn-success d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create New</button> -->
                                </div>
                            </div>
                        ...
                        <a href="?action=add"><button type="button" class="btn btn-success m-b-10"><i class="fa fa-plus-circle"></i> Add Type User</button></a>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Manage Type User</h4>
                                        <h6 class="card-subtitle">Type User Data</h6>
                                        <hr>
