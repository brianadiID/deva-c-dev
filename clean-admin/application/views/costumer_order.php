                          ...
                          <table class="table table-hover center">
                            ...
                            <tbody>
                              <tr >
                                ...
                                <td>June</td>
                                <td>Rp.150.000</td>
                                <td  class="bg_blue radius">Dikirim</td>
                                <td><a href="<?php echo base_url().'costumer/order_detail'?>"><button class="btn btn-default">View</button></a></td>
                              </tr>
                              <tr>
                                <td># 1135</td>
                                <td>July</td>
                                <td>Rp.250.000</td>
                                <td  class="bg_green radius">Diterima</td>
                                <td><a href="<?php echo base_url().'costumer/order_detail'?>"><button class="btn btn-default">View</button></a></td>
                              </tr>
                              <tr>
                                <td># 1433</td>
                                <td>April</td>
                                <td>Rp.390.000</td>
                                <td class="bg_red radius">Dibatalkan</td>
                                <td><a href="<?php echo base_url().'costumer/order_detail'?>"><button class="btn btn-default">View</button></a></td>
                              </tr>
                            </tbody>
                          </table>
