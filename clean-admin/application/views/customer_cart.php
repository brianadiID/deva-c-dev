...
<input type="hidden" name="1[rowid]" value="0f7b7f5f8cf0ded4442e3d2e91c79b0b">
 <?php foreach ($cart as $items) { ?>
                        <tr>
                            ...
                            <td><input type="text" name="1[qty]" value="<?php echo $items['qty']; ?>" class="text-center" maxlength="3" size="5">
 <button type="submit"><i class="fa fa-refresh" style="font-size:20px;padding: 0px;"></i></button></td>
