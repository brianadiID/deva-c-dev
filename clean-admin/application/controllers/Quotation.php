	...
	class Quotation extends CI_Controller{
    	...
    	function save_order(){
			...
			$provinsi_kota = $this->input->post('provinsi_kota');
			$no_telp = $this->input->post('no_telp');
			$total_bayar = $this->input->post('total_all');
		...
		function save_quotation(){
			...
			$no_order = $this->Quotation_model->generate_quotation_code();
			// echo $no_order;
	    	...
	    	if($this->Quotation_model->create($data['quotation'])){
	    		echo 'Berhasil';
	    		...
	    		foreach ($this->cart->contents() as $items) {
		    		...
		    		$this->Quotation_model->create_quotation_detail($data['order_detail']);
